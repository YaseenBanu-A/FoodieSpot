...
import BiryaniImg from "../../assets/website/biryani_cover.jpg";
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                <img
                  src={BiryaniImg}
                  alt="biryani img"
                  className="max-w-[430px] w-full mx-auto  rounded-xl drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)]"
                />
              </div>
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                <div>
                  <button  onclick={handleOrderPopup} className="bg-gradient-to-r from-primary to-secondary text-white py-2 px-4 rounded-full shadow-xl hover:shadow-md">
                    Order Now
                  </button>
                </div>
              </div>
